    ...
    <div class="container-fluid">
        <div class="row row-cols-3">
            ...
            <div class="col-5 overflow-auto" style="max-height: 84vmin;padding-right:35px;"><a href="../templates/admin.php"
                ...
                <?php
                $queryy = "SELECT Id, userinfo_id,UserInquiryName, UserInquiryEmail, InquiryTime, InquiryDateString, UserInquiry, InquiryStatus, InquiryReply, InquiryAttachment FROM UserInquiries ORDER BY InquiryTime DESC";
...
/* 
                ...
                echo '
                    ...
                    ?>
				<hr>
				<h4 class="card-title">Reply to Inquiry</h2>
				<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?id=" . $id; ?>">
					<label for="reply">Enter Reply:</label><br>
					<textarea id="reply" name="reply" rows="4" cols="50"></textarea><br>
					<button type="submit">Submit Reply</button>&emsp;<button href="../templates/admin.php">Cancel</button>
				</form>
					</div>
				</div>
            </div>
