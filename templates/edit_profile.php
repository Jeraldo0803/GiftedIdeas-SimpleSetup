                    ...
                    <div class="card-body">
                        ...
                        <form class="text-center" method="post">
                            ...
                            <div class="d-xl-flex d-xxl-flex justify-content-xl-center justify-content-xxl-center mb-3">
                                <a class="btn btn-primary btn-light" role="button" href="profile.php"
