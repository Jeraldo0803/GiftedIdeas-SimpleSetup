...
<body>
    <nav class="navbar navbar-expand-md sticky-top py-3" style="background: #A83565;">
        <div class="container-fluid"><a class="navbar-brand d-flex align-items-center" href="index.php" style="margin-left: -200px;padding: 0px;"><span style="color: rgb(255,255,255);"><img src="../assets/img/logo.png" style="max-width: 120px;" alt="Gifted Ideas"></span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-4"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            ...
            <div class="d-none d-md-block"><a class="btn btn-primary" role="button" style="font-family: 'Montserrat Alternates', sans-serif;font-size: 13px;background: #F44D92;width: 120px;border-color: var(--bs-navbar-toggler-border-color);border-radius: 5px;">Log out</a></div>
        </div>
    </nav>
                ...
                <div style="background: #FFE9C9;min-height: 100%;">
                    <div class="row text-center">
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <h1 style="font-family: 'Montserrat Alternates', sans-serif;font-size: 20px;font-weight: bold;margin-bottom: 0px;">Admin Name</h1>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <h1 style="font-family: 'Montserrat Alternates', sans-serif;font-size: 15px;">Admin Position</h1>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                ...
                <div>
                    <div class="card text-center" style="box-shadow: 1px 4px 20px rgba(0,0,0,0.25);">
                        <div class="card-body" style="padding: 25px 16px;">
                            <h4 class="card-title" style="font-family: Karla, sans-serif;font-weight: bold;">View User Information</h4>
                            <div class="row">
                                <div class="col">
                                    <h6 class="justify-content-xl-center align-items-xl-center mb-2" style="font-size: 13px;font-family: Karla, sans-serif;">New Registration</h6><a class="btn btn-primary" role="button" style="font-family: 'Montserrat Alternates', sans-serif;font-size: 13px;background: #A83565;width: 120px;border-color: var(--bs-navbar-toggler-border-color);border-radius: 5px;">View</a>
                                </div>
                                <div class="col">
                                    <h6 class="mb-2" style="font-size: 13px;font-family: Karla, sans-serif;">Edit Member</h6><a class="btn btn-primary" role="button" style="font-family: 'Montserrat Alternates', sans-serif;font-size: 13px;background: #A83565;width: 120px;border-color: var(--bs-navbar-toggler-border-color);border-radius: 5px;">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card text-center" style="margin-top: 40px;margin-bottom: 100px;box-shadow: 1px 4px 20px rgba(0,0,0,0.25), 1px 4px 20px rgba(0,0,0,0.25);">
                        <div class="card-body" style="padding: 25px 16px;">
                            <h4 class="card-title" style="font-family: Karla, sans-serif;font-weight: bold;">User Activities</h4><a class="btn btn-primary" role="button" style="font-family: 'Montserrat Alternates', sans-serif;font-size: 13px;background: #A83565;border-color: var(--bs-navbar-toggler-border-color);border-radius: 5px;min-width: 95%;margin-bottom: 10px;">View Queries</a><a class="btn btn-primary" role="button" style="font-family: 'Montserrat Alternates', sans-serif;font-size: 13px;background: #A83565;border-color: var(--bs-navbar-toggler-border-color);border-radius: 5px;min-width: 95%;">View</a>
                        </div>
                    </div>
                </div>
            </div>
