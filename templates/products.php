...
<body>
    ...
    <section class="photo-gallery py-4 py-xl-5">
        <div class="container">
            ...
            <div class="row gx-5 gy-5 row-cols-1 row-cols-sm-1 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-4 photos"
                data-bss-baguettebox="">
                <div class="col item"><a href="../assets/img/product1shirt.jpg">
                        <div class="card">
                            <div class="card-body" style="background: #dedede;text-align: center;"><img
                                    class="img-fluid" src="../assets/img/product1shirt.jpg">
                                <h4 class="card-title"
                                    style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;">Shirt
                                </h4>
                            </div>
                        </div>
                    </a></div>
                <div class="col item"><a href="../assets/img/product2mug.jpg">
                        <div class="card">
                            <div class="card-body" style="background: #dedede;text-align: center;"><img
                                    class="img-fluid" src="../assets/img/product2mug.jpg">
                                <h4 class="card-title"
                                    style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;">Mug</h4>
                            </div>
                        </div>
                    </a></div>
                <div class="col item"><a href="../assets/img/product3cup.jpg">
                        <div class="card">
                            <div class="card-body" style="background: #dedede;text-align: center;"><img
                                    class="img-fluid" src="../assets/img/product3cup.jpg">
                                <h4 class="card-title"
                                    style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;">Cup</h4>
                            </div>
                        </div>
                    </a></div>
                <div class="col item"><a href="../assets/img/product4pen.jpg">
                        <div class="card">
                            <div class="card-body" style="background: #dedede;text-align: center;"><img
                                    class="img-fluid" src="../assets/img/product4pen.jpg" style="background: #ffffff;">
                                <h4 class="card-title"
                                    style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;">Pen</h4>
                            </div>
                        </div>
                    </a></div>
                <div class="col item"><a href="../assets/img/product5jacket.jpg">
                        <div class="card">
                            <div class="card-body" style="background: #dedede;text-align: center;"><img
                                    class="img-fluid" src="../assets/img/product5jacket.jpg"
                                    style="background: #ffffff;">
                                <h4 class="card-title"
                                    style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;">Jacket
                                </h4>
                            </div>
                        </div>
                    </a></div>
                <div class="col item"><a href="../assets/img/product6pillow.jpg">
                        <div class="card">
                            <div class="card-body" style="background: #dedede;text-align: center;"><img
                                    class="img-fluid" src="../assets/img/product6pillow.jpg"
                                    style="background: #ffffff;" width="254" height="135">
                                <h4 class="card-title"
                                    style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;">Pillow
                                    case</h4>
                            </div>
                        </div>
                    </a></div>
                <div class="col item"><a href="../assets/img/product7phonecase.jpg">
                        <div class="card">
                            <div class="card-body" style="background: #dedede;text-align: center;"><img
                                    class="img-fluid" src="../assets/img/product7phonecase.jpg"
                                    style="background: #ffffff;">
                                <h4 class="card-title"
                                    style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;">Phone
                                    case</h4>
                            </div>
                        </div>
                    </a></div>
                <div class="col item"><a href="../assets/img/product8totebag.jpg">
                        <div class="card">
                            <div class="card-body" style="background: #dedede;text-align: center;"><img
                                    class="img-fluid" src="../assets/img/product8totebag.jpg"
                                    style="background: #ffffff;">
                                <h4 class="card-title"
                                    style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;">Tote bag
                                </h4>
                            </div>
                        </div>
                    </a></div>
