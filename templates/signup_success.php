                ...
                <div class="col text-center d-flex justify-content-center align-items-center">
                    <div>
                        <h2 class="text-uppercase fw-bold mb-3"
                            style="font-family: 'Montserrat Alternates', sans-serif;">RegiSTRATION COMPLETE</h2><button
                            class="btn btn-outline-light fs-5 py-2 px-4" type="button"
                            style="color: #000000;font-family: 'Montserrat Alternates', sans-serif;border-color: var(--bs-code-color);">Login</button>
                    </div>
                </div>
            </div>
        </div>
