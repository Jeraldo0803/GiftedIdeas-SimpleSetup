...
<body>
    ...
    <div class="row" style="height: 676.391px;">
        <div class="col-6 d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center" style="background: rgba(234,118,166,0.28);padding-left: 50px;border-color: rgba(0,0,0,0);">
            <div>
                <h1 style="font-family: 'Montserrat Alternates', sans-serif;font-size: 41px;">Browse all our products</h1>
                <p class="my-3"><br><br><br></p><a class="btn btn-primary btn-lg me-2" role="button" href="products.php" style="background: #a83565;font-family: 'Montserrat Alternates', sans-serif;width: 140px;font-size: 14px;border-style: none;border-radius: 5px;">Browse</a>
            </div>
        </div>
        <div class="col-6 d-md-flex d-xl-flex d-xxl-flex align-items-md-center align-items-xl-center align-items-xxl-center" style="padding-right: 0px;padding-left: 0px;"><img class="img-fluid w-100 fit-cover" src="../assets/img/homepagehero1.jpg"></div>
    </div>
    <div class="row" style="height: 676.391px;">
        <div class="col-6 d-md-flex align-items-md-center"><img class="w-100 fit-cover" src="../assets/img/homepagehero2.png"></div>
        <div class="col d-md-flex d-xl-flex align-items-md-center align-items-xl-center" style="background: rgba(234,118,166,0.28);padding-right: 75px;padding-left: 75px;">
            <div class="justify-content-xxl-center">
                ...
                <p class="my-3" style="font-size: 15px;font-family: 'Montserrat Alternates', sans-serif;">Use our patented product editor. Upload your brand logo and see how it looks on our merchandise!</p><a class="btn btn-primary btn-lg justify-content-xxl-center align-items-xxl-center me-2" role="button" href="product_editor.php" style="width: 176px;background: #a83565;font-size: 14px;font-family: 'Montserrat Alternates', sans-serif;border-style: none;border-radius: 5px;">Go to Product Editor</a>
            </div>
        </div>
    </div>
    <div class="container py-4 py-xl-5">
        <div class="row gy-4 gy-md-0">
            <div class="col-md-6"><img class="rounded img-fluid w-100 fit-cover" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png" style="min-height: 300px;"></div>
            <div class="col-md-6 d-md-flex align-items-md-center" style="font-family: 'Montserrat Alternates', sans-serif;">
                <div style="max-width: 350px;">
                    <h2 style="font-size: 41px;">About Us</h2>
                    <p class="my-3">We started from humble beginnings. It all started when...</p><a class="btn btn-primary btn-lg d-xxl-flex justify-content-xxl-center align-items-xxl-center me-2" role="button" href="about.php" style="width: 140px;background: #a83565;border-radius: 5px;font-size: 15px;">Learn more</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row row-cols-2 justify-content-xxl-center">
            <div class="col">
                ...
                <div>
                    ...
                    <p class="bg-body-tertiary border rounded border-0 p-4" style="font-family: 'Montserrat Alternates', sans-serif;">Service is great!</p><a class="btn btn-primary btn-lg d-xxl-flex justify-content-xxl-center align-items-xxl-center me-2" role="button" href="testimonials.php" style="width: 140px;background: #a83565;font-size: 15px;">Learn more</a>
                </div>
            </div>
            <div class="col">
                <div class="d-flex" style="margin-bottom: 40px;"><img class="rounded-circle flex-shrink-0 me-3 fit-cover" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png" width="200" height="200"></div>
    ...
    <footer class="text-white" style="font-family: 'Montserrat Alternates', sans-serif;background: #a83565;">
        <div class="container py-4 py-lg-5">
            <div class="row justify-content-center">
                <div class="col-sm-4 col-md-4 col-lg-4 col-xxl-3 text-center text-lg-start d-flex flex-column order-first item"><img>
                    <h3 class="fs-6 text-start text-white"><br>Address:<br>#000, City, Province</h3>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 col-xl-5 col-xxl-6 text-center text-lg-start d-flex flex-column align-items-center item">
                    <h1 class="fs-5 text-white">In partnership with:</h1>
                    <ul class="list-inline">
                        <li class="list-inline-item"><img class="rounded-circle flex-shrink-0 me-3 fit-cover" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png" width="70" height="70"></li>
                        <li class="list-inline-item"><img class="rounded-circle flex-shrink-0 me-3 fit-cover" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png" width="70" height="70"></li>
                        <li class="list-inline-item"><img class="rounded-circle flex-shrink-0 me-3 fit-cover" src="https://cdn.bootstrapstudio.io/placeholders/1400x800.png" width="70" height="70"></li>
                    </ul>
                </div>
