                            ...
                            <form class="text-center" method="post">
                                <div class="mb-3">
                                    ...
                                    <div class="row gx-5 gy-3">
                                        <div class="col">
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">First Name</p><input class="form-control" type="text" name="firstname" placeholder="<?php echo $userInfo['FirstName']; ?>" disabled/>
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">Middle Name</p><input class="form-control" type="text" name="middlename" placeholder="<?php echo $userInfo['MiddleName']; ?>" disabled/>
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">Nationality</p><input class="form-control" type="text" name="nationality" placeholder="<?php echo $userInfo['Nationality']; ?>" disabled />
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">Civil Status</p><input class="form-control" type="text" name="civilstatus" placeholder="<?php echo $userInfo['CivilStatus']; ?>" disabled />
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">District/Barangay</p><input class="form-control" type="text" name="barangay" placeholder="<?php echo $userInfo['DistrictBarangay']; ?>" disabled />
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">Email Address</p><input class="form-control" type="text" name="phonenum" placeholder="<?php echo $userInfo['EmailAddress']; ?>" disabled />
                                        </div>
                                        <div class="col">
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">Last Name</p><input class="form-control" type="text" name="lastname" placeholder="<?php echo $userInfo['Surname']; ?>" disabled />
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">Gender<input class="form-control" type="text" name="gender" placeholder="<?php echo $userInfo['Gender']; ?>" disabled /></p>
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">Place of Birth</p><input class="form-control" type="text" name="birthplace" placeholder="<?php echo $userInfo['PlaceofBirth']; ?>" disabled />
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">Home Address</p><input class="form-control" type="text" name="address" placeholder="<?php echo $userInfo['HomeAddress']; ?>" disabled />
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">Municipality/City</p><input class="form-control" type="text" name="city" placeholder="<?php echo $userInfo['MunicipalityCity']; ?>" disabled />
                                            <p class="text-start" style="margin-bottom: 0px;font-family: Karla, sans-serif;font-size: 14px;">Landline</p><input class="form-control" type="text" name="landlinenum" placeholder="<?php echo $userInfo['Landline']; ?>" disabled />
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <div></div>
                                ...
                                <div class="d-xl-flex d-xxl-flex justify-content-xl-center justify-content-xxl-center mb-3"><a class="btn btn-primary" role="button" href="edit_profile.php" style="font-family: 'Montserrat Alternates', sans-serif;font-size: 13px;background: #A83565;width: 120px;border-color: var(--bs-navbar-toggler-border-color);border-radius: 5px;">Edit</a></div>
                            </form>
                        </div>
                    </div>
                </div>
