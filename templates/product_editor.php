...
<body>
    ...
    <div class="container-fluid">
        <div class="row g-0">
            <div class="col-md-6">
                <div style="padding-top: 40px;padding-left: 60px;"><style>
    .drawing-area{
        position: absolute;
        z-index: 10;
        width: 420px;
...
<p id="editp">To remove a loaded picture on the T-Shirt select it and press the <kbd>DEL</kbd> key.</p>
...
<a id="savebtn "class="btn btn-light text-center me-2" role="button" onclick="saveFile()" style="width: 120px;color: rgb(168,53,101);font-family: 'Montserrat Alternates', sans-serif;font-size: 13px;border-radius: 5px;">Save Image</a>
<br><br>
                    ...
                    <div class="container">
                        <div class="row mb-5">
                            <div class="col-md-8 col-xl-6 text-center mx-auto">
                                <h2 style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;">Products Editor</h2>
                            </div>
                        </div>
                            ...
                            <div class="col item"><a id="product1" onclick="product1()" href="#">
                                    <div class="card">
                                        <div class="card-body" style="background: #dedede;text-align: center;padding-bottom: 0px;"><img class="img-fluid" src="../assets/img/product1shirt.jpg">
                                            <h6 class="card-title" style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;margin-top: 5px;">Shirt</h6>
                                        </div>
                                    </div>
                                </a></div>
                            <div class="col item"><a id="product2" onclick="product2()" href="#">
                                    <div class="card">
                                        <div class="card-body" style="background: #dedede;text-align: center;padding-bottom: 0px;"><img class="img-fluid" src="../assets/img/product2mug.jpg">
                                            <h6 class="card-title" style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;margin-top: 5px;">Mug</h6>
                                        </div>
                                    </div>
                                </a></div>
                            <div class="col item"><a id="product3" href="#" onclick="product3()">
                                    <div class="card">
                                        <div class="card-body" style="background: #dedede;text-align: center;padding-bottom: 0px;"><img class="img-fluid" src="../assets/img/product3cup.jpg">
                                            <h6 class="card-title" style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;margin-top: 5px;">Cup</h6>
                                        </div>
                                    </div>
                                </a></div>
                            <div class="col item"><a id="product4" href="#" onclick="product4()">
                                    <div class="card">
                                        <div class="card-body" style="background: #dedede;text-align: center;padding-bottom: 0px;"><img class="img-fluid" src="../assets/img/product4pen.jpg" style="background: #ffffff;">
                                            <h6 class="card-title" style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;margin-top: 5px;">Pen</h6>
                                        </div>
                                    </div>
                                </a></div>
                            <div class="col item"><a id="product5" href="#" onclick="product5()">
                                    <div class="card">
                                        <div class="card-body" style="background: #dedede;text-align: center;padding-bottom: 0px;"><img class="img-fluid" src="../assets/img/product5jacket.jpg" style="background: #ffffff;">
                                            <h6 class="card-title" style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;margin-top: 5px;">Jacket</h6>
                                        </div>
                                    </div>
                                </a></div>
                            <div class="col item"><a id="product6" href="#" onclick="product6()">
                                    <div class="card">
                                        <div class="card-body" style="background: #dedede;text-align: center;padding-bottom: 0px;"><img class="img-fluid" src="../assets/img/product6pillow.jpg" style="background: #ffffff;" width="254" height="135">
                                            <h6 class="card-title" style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;margin-top: 5px;">Pillow case</h6>
                                        </div>
                                    </div>
                                </a></div>
                            <div class="col item"><a id="product7" href="#" onclick="product7()">
                                    <div class="card">
                                        <div class="card-body" style="background: #dedede;text-align: center;padding-bottom: 0px;"><img class="img-fluid" src="../assets/img/product7phonecase.jpg" style="background: #ffffff;">
                                            <h6 class="card-title" style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;margin-top: 5px;">Phone case</h6>
                                        </div>
                                    </div>
                                </a></div>
                            <div class="col item"><a id="product8" href="#" onclick="product8()">
                                    <div class="card">
                                        <div class="card-body" style="background: #dedede;text-align: center;padding-bottom: 0px;"><img class="img-fluid" src="../assets/img/product8totebag.jpg" style="background: #ffffff;">
                                            <h6 class="card-title" style="font-family: 'Montserrat Alternates', sans-serif;font-weight: bold;margin-top: 5px;">Tote bag</h6>
                                        </div>
                                    </div>
                                </a></div>
                        </div>
